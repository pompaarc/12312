https://panel.frienworld.space/assets/vendors~auth~dashboard~server.d0ae34cd.js - 
    ...
    [0], {
        157: function (t, e, n) {
            ...
            var l = f,
                ...
                _ = y.call(Object);
            var j = function (t) {
                    if (!Object(p.a)(t) || "[object Object]" != Object(h.a)(t)) return false;
                    var e = Object(v.a)(t);
            ...
            function Y(t, e, n, r) {
                ...
                for (var i = 0, a = Object.keys(t); i < a.length; i++) {
                    var u = a[i],
                        o = t[u];
                    N(o) ? n.get(o) || (n.set(o, true), r[u] = Array.isArray(o) ? [] : {}, Y(o, e, n, r[u])) : r[u] = e
                }
                return r
            }
                    ...
                    dt = Object(r.useCallback)((function (t) {
                        ...
                        if (e) {
                            var a = t.type,
                                ...
                                o = t.as,
                                c = t.multiple;
                            "checkbox" === a ? void 0 === u ? i.checked = !!r : (i.checked = !(!Array.isArray(r) || !~r.indexOf(u)), i.value = u) : "radio" === a ? (i.checked = r === u, i.value = u) : "select" === o && c && (i.value = i.value || [], i.multiple = true)
                        }
                        return i
                    }), [Q, Z, F.values]),
            ...
            function ct(t) {
                ...
                }), [u, o, s, f]), s || Object(k.a)(false), [n(c), i(s), a(s)]
            }
            ...
            function ht(t) {
                var e = function (e) {
                        return Object(r.createElement)(K, null, (function (n) {
                            return n || Object(k.a)(false), Object(r.createElement)(t, Object.assign({}, e, {
                                formik: n
                            }))
                        }))
                    },
        ...
        165: function (t, e, n) {
            ...
            var _ = function (t, e, n) {
                for (var r = -1, i = (e = p(e, t)).length, a = false; ++r < i;) {
            ...
            function ut(t, e) {
                if (void 0 === e && (e = false), null == t || !0 === t || !1 === t) return "" + t;
                var n = typeof t;
            ...
            var ct = {
                    ...
                    notType: function (t) {
                        var e = t.path,
                            ...
                            i = t.originalValue,
                            a = null != i && i !== r,
                            u = e + " must be a `" + n + "` type, but the final value was: `" + ot(r, true) + "`" + (a ? " (cast from the value `" + ot(i, true) + "`)." : ".");
            ...
            var qt = function (t, e, n, r, i, a, u) {
                    ...
                    case "[object Set]":
                        var c = 1 & r;
                        if (o || (o = C), t.size != e.size && !c) return false;
                        var s = u.get(t);
                        if (s) return s == e;
                        r |= 2, u.set(t, e);
            ...
            var Ht = function (t, e, n, r, i, a) {
                    var u = 1 & n,
                        o = Object(Gt.a)(t),
                        c = o.length;
                    if (c != Object(Gt.a)(e).length && !u) return false;
                    for (var s = c; s--;) {
                        var f = o[s];
                        if (!(u ? f in e : Wt.call(e, f))) return false
                    }
                    var l = a.get(t);
                    ...
                    if (h && !v) {
                        var y = t.constructor,
                            m = e.constructor;
                        y == m || !("constructor" in t) || !("constructor" in e) || "function" == typeof y && y instanceof y && "function" == typeof m && m instanceof m || (h = false)
                    }
            ...
            var ne = function (t, e, n, r) {
                    ...
                    for (t = Object(t); i--;) {
                        var o = n[i];
                        if (u && o[2] ? o[1] !== t[o[0]] : !(o[0] in t)) return false
                    }
                    for (; ++i < a;) {
                        var c = (o = n[i])[0],
                            s = t[c],
                            f = o[1];
                        if (u && o[2]) {
                            if (void 0 === s && !(c in t)) return false
                        } else {
                            var l = new kt.a;
                            if (r) var h = r(s, f, c, t, e, l);
                            if (!(void 0 === h ? ee(f, s, 3, r, l) : h)) return false
                        }
                    }
                    return true
                },
            ...
            var me = function (t, e) {
                ...
                Oe = function () {
                    function t(t, e) {
                        ...
                        this.path = this.key.slice(n.length), this.getter = this.path && Object(_e.getter)(this.path, true), this.map = e.map
                    }
                    var e = t.prototype;
            ...
            var xe = function () {
                ...
                return e.describe = function () {
                    ...
                    if (this.list.has(t)) return true;
                    for (var n, r = this.refs.values(); !(n = r.next()).done;)
                        if (e(n.value) === t) return true;
                    return false
                }, e.clone = function () {
                    var e = new t;
            ...
            for (var Te = Ae.prototype = {
                    ...
                    isValid: function (t, e) {
                        return this.validate(t, e).then((function () {
                            ...
                            if ("ValidationError" === t.name) return false;
                            throw t
                        }))
                    },
                    ...
                    test: function () {
                        ...
                        return e._exclusive[t.name] = !!t.exclusive, e.tests = e.tests.filter((function (e) {
                            if (e.OPTIONS.name === t.name) {
                                if (r) return false;
                                if (e.OPTIONS.test === n.OPTIONS.test) return false
                            }
                            return true
                        })), e.tests.push(n), e
                    },
            ...
            var an = function (t) {
                ...
                mn = "(?:" + vn + "|" + pn + ")",
                _n = "(?:" + yn + "|" + pn + ")",
                jn = "(?:['вЂ™](?:d|ll|m|re|s|t|ve))?",
                gn = "(?:['вЂ™](?:D|LL|M|RE|S|T|VE))?",
                On = "(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?",
                Fn = "[\\ufe0e\\ufe0f]?",
            ...
            function Nn(t, e) {
                ...
                return t.some((function (t, r) {
                    if (-1 !== e.path.indexOf(t)) return n = r, true
                })), n
            }
            ...
            Ue(Hn, Ae, {
                ...
                _cast: function (t, e) {
                    ...
                    var a = this.fields,
                        ...
                        s = Object(r.a)({}, e, {
                            parent: c,
                            __validating: e.__validating || false
                        }),
                        f = false;
                ...
                _validate: function (t, e) {
                    ...
                    return n = this._option("abortEarly", e), i = this._option("recursive", e), e = Object(r.a)({}, e, {
                        ...
                        var f, l, h = a._nodes.map((function (n) {
                            ...
                            return o && o.validate ? (f.strict = true, o.validate(t[n], f)) : function (t) {
                                return t ? mt.SynchronousPromise : Promise
                            }(u).resolve(true)
                        }));
                        return wt({
                ...
                noUnknown: function (t, e) {
                    void 0 === t && (t = true), void 0 === e && (e = ht.noUnknown), "string" == typeof t && (e = t, t = true);
                    var n = this.test({
                        name: "noUnknown",
                        exclusive: true,
                        message: e,
                ...
                unknown: function (t, e) {
                    return void 0 === t && (t = true), void 0 === e && (e = ht.noUnknown), this.noUnknown(!t, e)
                },
            ...
            Qn.prototype.__isYupSchema__ = true;
            var Xn = Ve,
                tr = function (t, e) {
                    return new Oe(t, e)
                }
        ...
        211: function (t, e, n) {
            ...
            var o = function (t) {
                var e = this.__data__,
                    n = a(e, t);
                return !(n < 0) && (n == e.length - 1 ? e.pop() : u.call(e, n, 1), --this.size, true)
            };
            var c = function (t) {
                var e = this.__data__,
                    n = a(e, t);
        ...
        224: function (t, e, n) {
            ...
            function o(t) {
                this.status = i, this._continuations = [], this._parent = null, this._paused = false, t && t.call(this, this._continueWith.bind(this), this._failWith.bind(this))
            }
            ...
            if (o.prototype = {
                    ...
                    pause: function () {
                        return this._paused = true, this
                    },
                    resume: function () {
                        var t = this._findFirstPaused();
                        return t && (t._paused = false, t._runResolutions(), t._runRejections()), this
                    },
        ...
        240: function (t, e, n) {
            ...
            var y = function (t) {
                ...
                m = n(221);
            var _ = function (t) {
                return Object(m.a)(t) ? Object(h.a)(t, true) : y(t)
            };
            var j = function (t, e) {
                    return t && s(e, _(e), t)
                },
            ...
            var it = function (t) {
                ...
                st = "[object Object]",
                ft = {};
            ft[ot] = ft["[object Array]"] = ft["[object ArrayBuffer]"] = ft["[object DataView]"] = ft["[object Boolean]"] = ft["[object Date]"] = ft["[object Float32Array]"] = ft["[object Float64Array]"] = ft["[object Int8Array]"] = ft["[object Int16Array]"] = ft["[object Int32Array]"] = ft["[object Map]"] = ft["[object Number]"] = ft[st] = ft["[object RegExp]"] = ft["[object Set]"] = ft["[object String]"] = ft["[object Symbol]"] = ft["[object Uint8Array]"] = ft["[object Uint8ClampedArray]"] = ft["[object Uint16Array]"] = ft["[object Uint32Array]"] = true, ft["[object Error]"] = ft[ct] = ft["[object WeakMap]"] = false;
        ...
        295: function (t, e, n) {
            ...
            var r = n(184),
                ...
                a = n(174),
                u = {};
            u["[object Float32Array]"] = u["[object Float64Array]"] = u["[object Int8Array]"] = u["[object Int16Array]"] = u["[object Int32Array]"] = u["[object Uint8Array]"] = u["[object Uint8ClampedArray]"] = u["[object Uint16Array]"] = u["[object Uint32Array]"] = true, u["[object Arguments]"] = u["[object Array]"] = u["[object ArrayBuffer]"] = u["[object Boolean]"] = u["[object DataView]"] = u["[object Date]"] = u["[object Error]"] = u["[object Function]"] = u["[object Map]"] = u["[object Number]"] = u["[object Object]"] = u["[object RegExp]"] = u["[object Set]"] = u["[object String]"] = u["[object WeakMap]"] = false;
            var o = function (t) {
        ...
        296: function (t, e, n) {
            ...
            function o(t, e) {
                ...
                if (t && e && "object" == typeof t && "object" == typeof e) {
                    var n, c, s, f = r(t),
                        l = r(e);
                    if (f && l) {
                        if ((c = t.length) != e.length) return false;
                        for (n = c; 0 != n--;)
                            if (!o(t[n], e[n])) return false;
                        return true
                    }
                    if (f != l) return false;
                    ...
                    var b = i(t);
                    if ((c = b.length) !== i(e).length) return false;
                    for (n = c; 0 != n--;)
                        if (!a.call(e, b[n])) return false;
                    if (u && t instanceof Element && e instanceof Element) return t === e;
                    for (n = c; 0 != n--;)
                        if (!("_owner" === (s = b[n]) && t.$$typeof || o(t[s], e[s]))) return false;
                    return true
                }
                return t != t && e != e
            }
            t.exports = function (t, e) {
                try {
                    ...
                    if (t.message && t.message.match(/stack|recursion/i) || -2146828260 === t.number) return console.warn("Warning: react-fast-compare does not handle circular references.", t.name, t.message), false;
                    throw t
                }
            }
        },
